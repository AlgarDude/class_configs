...
local _ClassConfig = {
    ...
    ['DefaultConfig']     = {
        ...
        ['DoHPBuff']     = {
            ...
            Answer = "Disable Group HP Buff to prevent issues with Aego/Symbol lines overwriting. Alternatively, you can adjust the settings for the other class instead.",
        },
    },
}
