...
local Tooltips                    = {
    ...
    FireBuffSong   	 = "Song Line: Fire DD Spell Damage Increase + Effiency",
...
local _ClassConfig = {
	...
	['Cures']             = {
        CureNow = function(self, type, targetId)
            ...
            return RGMercUtils.UseSpell(cureSong.RankName.Name(), targetId, true)
        end,
    },
    ['ItemSets']      = {
        ['Epic'] = {
	...
	--TODO: Assess usage of PCAAReady and NPCAAReady, etc, depending on ability
    ['Rotations']     = {
        ['Burn'] = {
            {
                name = "Quick Time",
        ...
        ['DPS'] = {
            ...
            },]]
			{
                ...
                cond = function(self, itemName)
					...
					return (RGMercUtils.GetSetting('UseEpic') == 3 or (RGMercUtils.GetSetting('UseEpic') == 2 and RGMercUtils.BurnCheck())) and mq.TLO.FindItem(itemName)() and mq.TLO.FindItem(itemName).TimerReady() == 0
                end,
            },
            {
                name = "Fierce Eye",
	...
	--Regen/Healing
		...
		['UseCrescendo']		= { DisplayName = "Crescendo Delayed Heal", Category = "Regen/Healing", Index = 2, Tooltip = Tooltips.CrescendoSong, RequiresLoadoutChange = true, Default = true, },
	...
	--DPS - Self
		['UseBellow']			= { DisplayName = "Use Bellow:", Category = "DPS - Self", Index = 1, Tooltip = "Use Boastful Bellow", Type = "Combo", ComboOptions = { 'Never', 'Burns Only', 'All Combat', }, Default = 3, Min = 1, Max = 3, },
		...
		['UseDiseaseDots']		= { DisplayName = "Use Disease Dots", Category = "DPS - Self", Index = 6, Tooltip = Tooltips.DiseaseDotSong, RequiresLoadoutChange = true, Default = true, },
		['UseJonthan']			= { DisplayName = "Use Jonthan", Category = "DPS - Self", Index = 7, Tooltip = Tooltips.Jonthan, Type = "Combo", ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', }, Default = 1, Min = 1, Max = 4, RequiresLoadoutChange = true,},
	--DPS - Group
		['UseFierceEye']		= { DisplayName = "Fierce Eye Use:", Category = "DPS - Group", Index = 2, Tooltip = "When to use the Fierce Eye AA.", Type = "Combo", ComboOptions = { 'Never', 'Burns Only', 'All Combat', }, Default = 3, Min = 1, Max = 3, },
		['UseArcane']			= { DisplayName = "Use Arcane Line", Category = "DPS - Group", Index = 2, Tooltip = Tooltips.Arcane, Type = "Combo", ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', }, Default = 3, Min = 1, Max = 4, RequiresLoadoutChange = true,},
		['UseDicho']			= { DisplayName = "Psalm (Dicho) Use:", Category = "DPS - Group", Index = 2, Tooltip = Tooltips.DichoSong, Type = "Combo", ComboOptions = { 'Never', 'During QuickTime', 'All Combat', }, Default = 2, Min = 1, Max = 3, RequiresLoadoutChange = true, },
		...
		['UseFireBuff']			= { DisplayName = "Use Fire Spell Buff", Category = "DPS - Group", Index = 2, Tooltip = Tooltips.FireBuffSong, Type = "Combo", ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', }, Default = 1, Min = 1, Max = 4, RequiresLoadoutChange = true,},
		['UseColdBuff']			= { DisplayName = "Use Cold Spell Buff", Category = "DPS - Group", Index = 2, Tooltip = Tooltips.ColdBuffSong, Type = "Combo", ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', }, Default = 1, Min = 1, Max = 4, RequiresLoadoutChange = true,},
        ['UseDotBuff']			= { DisplayName = "Use Fire/Magic DoT Buff", Category = "DPS - Group", Tooltip = Tooltips.DotBuffSong, Type = "Combo", ComboOptions = { 'Never', 'In-Combat Only', 'Always', 'Out-of-Combat Only', }, Default = 1, Min = 1, Max = 4, RequiresLoadoutChange = true,},
		['UseAlliance']			= { DisplayName = "Use Alliance", Category = "DPS - Group", Index = 2, Tooltip = Tooltips.AllianceSong, RequiresLoadoutChange = true, Default = false, },
	...
	--Utility/Items/Misc
		['UseEpic']				= { DisplayName = "Epic Use:", Category = "Utility/Items/Misc", Index = 1, Tooltip = "Use Epic 1-Never 2-Burns 3-Always", Type = "Combo", ComboOptions = { 'Never', 'Burns Only', 'All Combat', }, Default = 1, Min = 1, Max = 3, },
		...
		['UseSoBItems']			= { DisplayName = "Do Sym. of Battle", Category = "Utility/Items/Misc", Index = 3, Tooltip = "Click your Symphony of Battle items.", Default = false, },
		['UseDreadstone']		= { DisplayName = "Dreadstone", Category = "Utility/Items/Misc", Index = 4, Tooltip = "Use your Dreadstone when able.", Default = false, },
