...
local _ClassConfig = {
    ...
    ['RotationOrder']     = {
        ...
        },
		{
            ...
            cond = function(self, combat_state)
                return combat_state == "Combat" and RGMercUtils.IsHealing() and RGMercUtils.GetSetting('DoTwinNuke') and not RGMercUtils.SongActiveByName("Healing Twincast") and not RGMercUtils.Feigning()
            end,
        },
        {
            name = 'Burn',
    ...
    ['Rotations']         = {
		['TwinHealNuke'] = {
            {
                name = "TwinHealNuke",
                type = "Spell",
                cond = function(self, _) return true end, --not RGMercUtils.SongActiveByName("Healing Twincast") end,
            },
        },
        ['DPS'] = {
            {
        ...
        ['GroupBuff'] = {
            ...
            },
            {
                ...
                cond = function(self, spell, target)
                    return not RGMercUtils.TargetHasBuff(spell) and RGMercUtils.SpellStacksOnTarget(spell) and target and target and
    ...
    ['Spells']            = {
        ...
        },
        {
            ...
            spells = {
                ...
                -- [ HEAL MODE ] --
                { name = "QuickGroupHeal", cond = function(self) return mq.TLO.Me.Level() >= 78 end, },
        ...
        },
        {
            ...
            spells = {
                ...
                {
                    name = function(self)
						local moon = RGMercUtils.GetResolvedActionMapItem('RemoteMoonDD')
						local sun = RGMercUtils.GetResolvedActionMapItem('RemoteSunDD')
						if not sun and sun() and moon and moon() then return false end
							
						if moon.Level() > sun.Level() then return { "RemoteMoonDD", }
						else return { "RemoteSunDD", }
						end,
                    cond = function(self)
    ...
    ['DefaultConfig']     = {
		...
		['DoTwinNuke']   = { DisplayName = "Cast Twin Heal Nuke", Category = "Spells and Abilities", Tooltip = "Use Twin Heal Nuke Spells", Default = true, },
